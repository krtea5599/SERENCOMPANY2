      ...
      <div className="w-full max-w-7xl flex flex-col md:flex-row items-start md:items-end gap-8 md:gap-12 animate-fadeIn">
        ...
        <div className="mb-4 max-w-2xl">
          <p className="text-lg md:text-2xl font-normal tracking-tight text-black/80 text-left leading-relaxed">
            ...
            <span className="font-black text-black/90">구조 설계</span>를 기반으로<span className="font-black text-black/90">브랜드</span>를 구축하는<br />
            세렌 대표이사 <span className="font-black text-[#1040DD]">이정한</span>입니다.<br />
            <br />
            저는 <span className="font-black text-black/90">아이디어</span>를 단순한 기획에 머무르지 않고,<br />
            <span className="font-black text-black/90">실행</span> 가능한 <span className="font-black text-black/90">시스템</span>으로 설계하여<br />
            <span className="font-black text-black/90">콘텐츠</span>, <span className="font-black text-black/90">교육</span>, <span className="font-black text-black/90">지식재산</span>, <span className="font-black text-black/90">사업</span>으로 확장합니다.<br />
            <br />
          </p>
        </div>
      </div>
